                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                    <strong>Bạn không biết vì sao mình
                                                                                        nhận được
                                                                                        mail này?</strong>
                                                                                </p>
                                                                                <p
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                    Một người khác không nhớ được mật
                                                                                    khẩu Tài khoản
                                                                                    {{ env('APP_NAME') }} của họ có thể
                                                                                    đã cung cấp nhầm địa
                                                                                    chỉ email của bạn. Bạn có thể bỏ qua
                                                                                    email này
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                    Để bảo vệ tài khoản của bạn, đừng
                                                                                    chuyển tiếp
                                                                                    email này hoặc cung cấp đường dẫn
                                                                                    này cho bất kỳ
                                                                                    ai.</p>
                                                                            </td>
                                                                        </tr>
