        ...
        <div class="activity">
            <div class="py-20">
                ...
                <form method="POST" action="{{ route('admin.category.update', $cate->id) }}">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="slug" id="floating_password"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ $cate->slug ?? '' }}" />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <textarea id="message" rows="4"
                            ...
                            placeholder="Write your thoughts here..." name="description">{{ $cate->description ?? '' }}</textarea>
                    </div>
                    <button type="submit"
