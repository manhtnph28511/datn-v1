                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center px-6 py-4 space-x-3">
                                            <a href="{{ route('admin.order.show', $order->id) }}"
                                                class="font-medium text-red-600 dark:text-red-500 hover:underline">Xem chi
                                                tiết
                                            </a>
                                        </td>
                                    </tr>
                    ...
                    @else
                        <div class="w-[600px] mx-auto">
                            ...
                            <span class="text-center block italic pb-[20px] text-gray-500">Không có đơn hàng</span>
                        </div>
                    @endif
                </div>
                {{-- End Table --}}
